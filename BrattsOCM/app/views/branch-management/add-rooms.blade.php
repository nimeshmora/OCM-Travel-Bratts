...
<div id="main">
    ...
    <div class="card-panel">
        <h4 class="header2">Add Room</h4>
        <div class="row">
            <form class="col s12" action="{{ URL::route('add-room-post') }}" method="post" enctype="multipart/form-data">

                <div class="row">
                    <div class="input-field col s12">
                        <input name="room_code" type="text" {{ (Input::old('room_code')) ? 'value="'. Input::old('room_code').'"' : '' }}>
                        @if($errors ->has('room_code'))

                            {{ $errors->first('room_code', '<small class=error>:message</small>') }}
                        @endif
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input name="price" type="number" {{ (Input::old('price')) ? 'value="'. Input::old('price').'"' : '' }}>
                        @if($errors ->has('price'))
