...
<div id="main">
    ...
    <div class="wrapper">
        ...
        <div class="card-panel">
            <h4 class="header2">Add Branch</h4>
            <div class="row">
                <form class="col s12" action="{{ URL::route('add-branch-post') }}" method="post">
                    <div class="row">
                        <div class="input-field col s12">
                            <input name="branch_name" type="text" {{ (Input::old('branch_name')) ? 'value="'. Input::old('branch_name').'"' : '' }}>
                            @if($errors ->has('branch_name'))

                                {{ $errors->first('branch_name', '<small class=error>:message</small>') }}
                            @endif
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input name="branch_code" type="text" {{ (Input::old('branch_code')) ? 'value="'. Input::old('branch_code').'"' : '' }}>
                            @if($errors ->has('branch_code'))

                                {{ $errors->first('branch_code', '<small class=error>:message</small>') }}
                            @endif
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input name="city" type="text" {{ (Input::old('branch_name')) ? 'value="'. Input::old('city').'"' : '' }}>
                            @if($errors ->has('city'))
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <select class="status" name="stats">
                        ...
                        <div class="input-field col s6">
                            <input name="date" type="date" class="datepicker" {{ (Input::old('date')) ? 'value="'. Input::old('date').'"' : '' }}>
                            @if($errors ->has('date'))
