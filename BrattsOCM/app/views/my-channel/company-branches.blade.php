...
<div id="main">
    ...
    <div class="card-panel">
        <h4 class="header2 strong">Available Branches</h4>
        <div class="row">
            <div id="row-grouping" class="section">
                <div class="row">
                    <div class="col s12 m8 l9">
                        <table id="data-table-row-grouping" class="display" cellspacing="0" width="130%">
                            <thead>
                            <tr>
                                <th>Branch Code</th>
                                <th>Branch Name</th>
                            ...
                            @if(isset($data))
                                @foreach ($data as $details)
                                    <tr>
                                        ...
                                        <td><a class="btn-floating  "><i class="mdi-action-done"></i></a></td>
                                        @else
                                            <td><a class="btn-floating  "><i class="mdi-content-clear"></i></a></td>

                                            @endif
                                        <td><p><a class="waves-effect waves-light btn light-blue   bookings" href="{{URL::route('reserve-user-details')}}" >Edit</a></p>

                                        </td>
                                        <td><p><a class="waves-effect waves-light btn light-pink   bookings" href="{{URL::route('reserve-user-details')}}" >Delete</a></p>
