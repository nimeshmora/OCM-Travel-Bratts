        ...
        <form class="login-form">
            <div class="row">
                <div class="input-field col s12 center">
                    ...
                    <h6>We have sent an email to your email address with the activation<br>link, Please click on it to continue.&nbsp;</h6>
                    <h6>If it is not received within next few<br>minutes please contact us and we will verify the account.</h6>
                    <h5>Thank You!</h5>
                </div>
            </div>
