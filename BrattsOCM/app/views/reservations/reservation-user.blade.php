            ...
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                        ...
                        <div class="row">
                            <form class="col s12" action="{{ URL::route('reserve-user-details-post') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input name="phone" type="number" {{ (Input::old('phone')) ? 'value="'. Input::old('phone').'"' : '' }}>
                                            @if($errors ->has('phone'))
